					...
					<li class="<c:if test="${cat.folded}">collapsed</c:if><c:if test="${!cat.folded}">expanded</c:if>">
						<div class="fl-force-left">
							<a href="
								...
								<c:if test="${cat.folded}"><img src="<c:url value="/media/plus.gif"/>" alt="<spring:message code="expandCategory"/>"></c:if>
								<c:if test="${!cat.folded}"><img src="<c:url value="/media/moins.gif"/>" alt="<spring:message code="colapseCategory"/>"></c:if>
							</a>
						</div>
