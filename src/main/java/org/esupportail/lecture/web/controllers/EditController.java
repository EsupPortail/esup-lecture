...
public class EditController extends TwoPanesController {
	...
	public void toogleSourceSubcribtion(@RequestParam(required = true, value = "p1") String catID,
	...
	public void toogleCategorySubcribtion(@RequestParam(required = true, value = "p1") String ctxID,
