...
<table class="portlet-table-body">
	<tr>
		...
		<ul>
			...
			<li class="expended"><span class="portlet-section-alternate">Vie culturelle</span>
			<ul>
		...
		Cette inscription officialise votre statut d'étudiant avec l'envoi de
		votre carte d'étudiant.</p>
		</div>
